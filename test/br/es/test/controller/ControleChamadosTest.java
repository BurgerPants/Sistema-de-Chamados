...
import br.es.controller.ControleChamados;
import br.es.entities.BancoDeDados;
import br.es.entities.Chamado;
import br.es.entities.ClienteEmpresa;
import br.es.entities.Empresa;
import br.es.entities.RegistroChamado;
import br.es.entities.SistemaOperacional;
import br.es.entities.Status;
import br.es.entities.Tecnico;
import br.es.entities.TipoConexao;
...
public class ControleChamadosTest {
    ...
    public void alterarChamadoAlteradoTest(){
        ...
        ClienteEmpresa clienteEmpresa = new ClienteEmpresa(123, empresa, 12345678912L, "Guilherme.S", 59205920);
        Tecnico tecnico = new Tecnico("Guilherme.M",46612321);
    ...
    public void obterDetalhesChamado(){
        ...
        String detalhes = "\n" + "--------" + "\n" + "Data de abertura do chamado: "
                ...
                + "Guilherme.M" + "\n" + "Cliente requisitor do chamado: " + "Guilherme.S" + "\n";
